...
class Sms
{
    ...
    public static function request($smsData)
    {
        $client=new \SoapClient(self::wsdl);
        $sms=array(
            'Msisdns'=>$smsData->mobile,
            'SMSContent'=>'【区块链社区】验证码：'.$smsData->code.'，有效期为2分钟，如非本人操作，请忽略。',
            'ExtNumber'=>'',
        );
        //定时发送
...
//            echo "faultcode:",$result->faultcode,"faultstring:",$result->faultstring;
        ...
        else
        {
            ...
            return $data->StatusCode == 'OK' && $data->SuccessCounts > 0;
        }
    }
}
